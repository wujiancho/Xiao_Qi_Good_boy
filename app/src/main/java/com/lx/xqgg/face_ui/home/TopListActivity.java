        ...
        switch (type) {
            ...
            case 2:
                ...
                list.add(new TopListBean("《工商注册》", R.drawable.ic_gszc
                        ...
                        "五、资产中的重头戏\n\n" +
                        "六、员工的勋章"
                        , "商标专用权质押业务是以企业所有权质押,通过第三方评估其价值，采用灵活的抵、质押模式,为企业发放相对比例。商标凝结了所标识产品、服务，以及该商品经营者、服务提供者的信誉，商标是服务信誉和与之相关的企业荣誉的最好标示。"));
