...
public class GgItemAdapter extends BaseQuickAdapter<QccBean.ResultBean.EmployeesBean, BaseViewHolder> {
    private String company;
    public GgItemAdapter(@Nullable List<QccBean.ResultBean.EmployeesBean> data,String company) {
        super(R.layout.item_qcc_main_gg, data);
    ...
    protected void convert(BaseViewHolder helper, QccBean.ResultBean.EmployeesBean item) {
        ...
        helper.setText(R.id.tv_tag1,item.getJob());
