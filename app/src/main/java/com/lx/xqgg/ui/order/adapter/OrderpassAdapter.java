...
public class OrderpassAdapter extends BaseQuickAdapter<OrderBean.RecordsBean, BaseViewHolder> {
    private DealBean dealBean;
    private OrderBean.RecordsBean orderBean;
    public OrderpassAdapter(@Nullable List<OrderBean.RecordsBean> data) {
